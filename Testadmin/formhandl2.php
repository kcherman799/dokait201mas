...
// Скипт для обработки формы заявки на участие в дни открытый дверый в коллежда 
	...
	$from = "chermanteevthomas723@gmail.com"; // От кого
	$subjct = "День открытых дверей в КАИТЕ"; // Тема сообшение
	//
     //mail($to, $subjct, $message, $header) , $header Функция mail(кому, тема сообшение, заголовок сообщение), отправляет сообшение на почту
