...
<html>
	...
	<body>
			...
			<div id=\"SubDiv\">
				...
				<table>
					...
					<tr>
						...
						<td> <a class=\"EditRec\" href=\"Formdelpost.php?id=". $RecPost["id"]. " \" title=\"Удалить\"> Удалить </a> </tr>"); // Выводим страницу из БД на экран 
						}	
				echo("
				</table>
		...
		"); // Показываем страницу для удаление поста пользователю
	}
