<?php
	// Скрипт для редактирование страницы
			...
			<div id=\"SubDiv\">
				...
				$SelectPage = getListPage(); // Получаем список страниц из БД
					...
					<tr>
						...
						<td> <a class=\"EditRec\" href=\"Formeditpage.php?id=". $RecPage["id"]. " \" title=\"Редактировать\"> Редактировать </a> </tr>"); // Выводим страницу из БД на экран 
						}	
				echo("
				</table>
